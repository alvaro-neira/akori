...
[userx, usery]=userNavIntersection(userNumber,qid,ts_nav,ts_gaze,user_url(userNumber), url_prefix, gaze_x,gaze_y);
for i=1:length(object_id)
    processObject(userx,usery,x(i),y(i),width(i),height(i),xoffsets(userNumber),yoffsets(userNumber));
