function [P, counters, numberOfFocuses] = getPartitionsNeutralSites( focusThreshold, nPartitions )
    global maxx;
    global datapath;
    global url_prefix;
    global xoffsets;
    ...
    for persona=1:len1
        ...
        for pregunta=1:len2
            ...
            for fijacion=1:len3
                ...
                P(counters(randN),randN,1)= std(D2_o1);
                P(counters(randN),randN,2)= std(A1_o1);
                P(counters(randN),randN,3)= sumsqr(D2_o1);
                P(counters(randN),randN,4)= sumsqr(A1_o1);
                P(counters(randN),randN,5)= std(A4_o2);
                P(counters(randN),randN,6)= std(D2_o2);
                P(counters(randN),randN,7)= std(A1_o2);
                P(counters(randN),randN,8)= sumsqr(A4_o2);
                P(counters(randN),randN,9)= sumsqr(D2_o2);
                P(counters(randN),randN,10)= sumsqr(A1_o2);
                P(counters(randN),randN,11)= max(pupil_area);
                P(counters(randN),randN,12)= min(pupil_area);
                P(counters(randN),randN,13)= mean(pupil_area);
                P(counters(randN),randN,14)= contraccionMaxima( pupil_area );
                P(counters(randN),randN,15)= max(o1);
                P(counters(randN),randN,16)= max(o2);
                P(counters(randN),randN,17)= std(o2);
